...
const DebtTrackerScreen = () => {
  ...
  const [debts, setDebts] = useState([
    { id: 1, name: 'Credit Card', amount: 3500, totalAmount: 5000, color: '#F44336' },
    { id: 2, name: 'Student Loan', amount: 15000, totalAmount: 25000, color: '#9C27B0' },
    { id: 3, name: 'Car Loan', amount: 8000, totalAmount: 12000, color: '#FF9800' },
  ]);
