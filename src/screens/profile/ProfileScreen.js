  ...
  const fetchUserProfile = async () => {
    try {
      ...
      if (data) {
        ...
        setProfileBio(data.bio || 'Set your financial goal!');
        setGender(data.gender || 'male');
        setNotifications(data.notifications !== undefined ? data.notifications : true);
        setDataSharing(data.data_sharing !== undefined ? data.data_sharing : true);
        setMarketingEmails(data.marketing_emails !== undefined ? data.marketing_emails : true);
      }
    } catch (error) {
